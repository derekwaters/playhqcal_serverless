...
app.http('FetchCal', {
    ...
    handler: async (request, context) => {
		...
		let scheduleUrlMap = {
			...
			"angus_u20": "https://www.playhq.com/basketball-victoria/org/mckinnon-cougars-basketball-club/5f84fbd9/victorian-junior-basketball-league-2025/teams/mckinnon-u20-boys-1-vc/1fbc9b82",
